...
{
    private $view = 'panel/usuarios'; // Vista del dashboard
    ...
    public function index()
    {
        ...
        $data['usuarios'] = $usuarioModel->getUsuarios(); // Obtener usuarios de la base de datos

        return $this->make_view($this->view, $data); // Pasa los datos a la vista
    }
}
